...
#[simplex::test]
fn u16_convert_test_safe_u16_to_u1_overflow(context: simplex::TestContext) -> anyhow::Result<()> {
...
#[simplex::test]
fn u16_convert_test_safe_u16_to_u8_overflow(context: simplex::TestContext) -> anyhow::Result<()> {
